 ...
 * @author genil
 */
public class TodaPerguta extends javax.swing.JFrame {

    /**
     * Creates new form TodaPerguta
     */
    public TodaPerguta() {
        initComponents();
        setSize(1050, 535);
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 140, 820, 260));

        jLabel9.setFont(new java.awt.Font("Algerian", 1, 40)); // NOI18N
        jLabel9.setText("todas Questões");
        ...
        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/View/Imagem/all questions.png"))); // NOI18N
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 10, -1, -1));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/View/Imagem/pages background admin.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TodaPerguta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
